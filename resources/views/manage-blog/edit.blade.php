...
<div class="container col-md-4">
    <a href="{{ route('manage-blog.index') }}" class="btn btn-primary float-right">Back</a>
    ...
    <form action="{{ route('manage-blog.update',$blog->id) }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PUT')
